...
""" get_mental_maps.py: Retrieve and write as .json files all the system support
    ...
    only in those dicts which contain a "schoolLocation" key because only
    those have been generated by the website custom-modified for the "Roles in
    Mental Health Care within Schools in Connecticut" research study.
    ...
    -> write each dict with key "schoolLocation" to file
"""
